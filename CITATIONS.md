...
- **Brennan, K., & Wolf, J. (2025).** *Vibe Coding (Module Syllabus).* Harvard Graduate School of Education.
- **CDC (2026).** *Considerations for Agentic Research in Public Health.* Centers for Disease Control and Prevention.
- **Kinlay, J. (2026).** *Agentic Workflows for Alpha Research.* JonathanKinlay.com.
- **Kumar, S. (2026).** *The State of Vibe Coding: A 2026 Strategic Blueprint.* Keywords Studios.
...
- **Bavarva, S. (2026).** *Secure Vibe Coding in 2026: The Files, Prompts and Rules of Use and Research.* Medium.
- **Collins Dictionary (2025).** *Word of the Year 2025: Vibe Coding.*
- **Merriam-Webster (2025).** *Slang & Trending: Vibe Coding.*
