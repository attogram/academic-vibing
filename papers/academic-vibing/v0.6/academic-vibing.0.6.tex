...
\title{Academic Vibing v0.6: Consensus Poisoning and the Leapfrog Mechanism}
...
\begin{abstract}
[ROCK TALK]: Academic Vibing v0.6. Core: CDI (Consensus Divergence Index). New: Leapfrog Mechanism (F2). Defense: Adversarial Rigor against Consensus Poisoning (E10) and HN Breach (E8). Productivity + Wellbeing Surplus.
\end{abstract}
