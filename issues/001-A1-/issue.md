...
1. **ArXiv submission** (rock-talk needs final copyedit + empirical data?)
2. **Roll the dice on F-phase** (spawn Jules as autonomous agent, see if she can actually execute the roadmap?)
3. **Build academic-vibing as the *epistemological foundation*** (make it the thing that *justifies* rock-talk's existence?)
