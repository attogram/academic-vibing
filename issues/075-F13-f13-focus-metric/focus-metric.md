# Issue #75: F13 Focus metric

**State:** OPEN
**Code:** F13
**Created:** 2026-06-19T13:46:48Z
**GitHub:** https://github.com/attogram/academic-vibing/issues/75

---

What you’re describing is actually a real and known failure mode in systems like yours.

In plain terms:

> You built a system that is too good at generating branching research space and not good enough at closing search.



That’s not a “bug in you” — it’s a known property of LLM-driven ideation systems.
...
If your goal is arXiv-grade rigor, your metric must answer ONE question:
...
> “Interesting generative system, but no defined experimental protocol.”
...
If you want, I can help you design a **minimal 3-signal control system (CDI + Focus + Closure)** that would actually make this arXiv-stable instead of continuously expanding.
