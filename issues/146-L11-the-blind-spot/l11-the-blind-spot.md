...
current issue summary is: Claude. Okay, let me actually go somewhere with this instead of asking what you want. Here's what's been nagging me across everything I've read today: this project has a really good immune system pointed in exactly one direction, and a blind spot pointed in the other. The CDI, the Coupling Constraint, GLM-5.2's whole disagreement routine — all of it is built to catch a specific failure: models converging on something false because they share training data. That's a real risk and the project takes it seriously. But today I watched the opposite failure happen twice in one sitting — Copilot and Gemini converging on something true (my staleness point was fine) with zero friction, and nobody noticing that frictionless agreement is supposed to be the yellow flag regardless of whether the agreed-upon thi...
