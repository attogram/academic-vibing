...
# Rock Life 0.1: Field Notes on the Control Variable
...
the instrument's baseline state matters as much as its output. This is the
control variable.
...
No commits were made during this window. The instrument was, for several
hours, simply a person having a nice time.
...
itself is notable: even leisure consumption carried a low hum of the same
subject matter driving the sprint, suggesting the line between "research"
and "rest" was porous rather than absolute — but porous is not the same
as absent. Two full Netflix sessions and a music rabbit hole happened. The
sprint did not consume the whole weekend.
...
functioning. This appendix exists to make that baseline visible: sleep,
social time, food, entertainment, and rest occurred on a normal schedule
in parallel with the sprint, rather than being displaced by it.
