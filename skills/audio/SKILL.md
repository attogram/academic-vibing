...
- **Format:** Adhere to the ROCK / PROSE dual structure.
...
- **Method:** Translate the full ROCK and PROSE sections, ensuring technical terms (CDI, Leapfrog) are handled correctly.
