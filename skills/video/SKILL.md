...
v0.2: TTF Font Loading (DejaVuSans-Bold) + AAC Audio Encoding.
...
- **Typography:** v0.2+ uses TrueType fonts (`.ttf`) for clear, high-resolution text rendering at various scales.
